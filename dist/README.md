...
## Visão Geral
Focinhos Amados é um Progressive Web App (PWA) para agendamento de serviços de banho e tosa, além de Táxi Dog, focado em experiência mobile, performance, acessibilidade e integração com WhatsApp.
...
- `index.html`, `agendar.html`, `taxi.html`, `sobre.html`, `404.html`: páginas principais.
- `assets/`
